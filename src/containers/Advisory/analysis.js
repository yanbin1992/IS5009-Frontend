        ...
        return (
            <div className="Analysis">
                <div style={{ marginTop: 32, marginLeft: 20, marginBottom: 16 }}>
                    ...
                    <img
                        width={300}
                        src={require('./advData/beforeSpend.png')}
                        style={{ justifyContent: 'center' }}
                    />
                    <br />
                    <br />
                    <Button type="primary" style={{ display: 'flex', justifyContent: 'center' }} onClick={this.changeText.bind(this)}>Generate your report</Button>
                </div>
                {this.state.show == 1 ?
                    <div>
                        <div style={{ marginTop: 32, marginLeft: 20, marginBottom: 16 }}>
